...
public class Management {
	...
	public void InsertIn(Activity act){
		...
		}catch(IndexOutOfBoundsException ie){ // 예외처리
	...
	public String ToStringIn(int i){
		...
		String money = null;
		try {
			date = "<< 날짜 : " + infoIncome.get(i).GetDate().get(GregorianCalendar.YEAR) + "." 
					+ infoIncome.get(i).GetDate().get(GregorianCalendar.MONTH) + "."
					+ infoIncome.get(i).GetDate().get(GregorianCalendar.DAY_OF_MONTH) + " >> \n";
		
			memo = "<< 메모 : " + infoIncome.get(i).getMemo() + " >> \n";
		
			money = "<< 금액 : " + infoIncome.get(i).getMoney() + " >> \n";
	...
	public String ToStringOut(int i){
		...
		String money = null;
		try {
			date = "<< 날짜 : " + infoOutcome.get(i).GetDate().get(GregorianCalendar.YEAR) + "." 
					+ infoOutcome.get(i).GetDate().get(GregorianCalendar.MONTH) + "."
					+ infoOutcome.get(i).GetDate().get(GregorianCalendar.DAY_OF_MONTH) + " >> \n";
		
			memo = "<< 메모 : " + infoOutcome.get(i).getMemo() + " >> \n";
		
			money = "<< 금액 : " + infoOutcome.get(i).getMoney() + " >> \n";
